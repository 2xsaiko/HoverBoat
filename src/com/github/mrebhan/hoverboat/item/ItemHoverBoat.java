...
public class ItemHoverBoat extends Item {
	public static Item item = new ItemHoverBoat()
	.setCreativeTab(CreativeTabs.tabTransport)
	.setMaxStackSize(1)
	.setTextureName("minecraft:boat")
	.setUnlocalizedName("ItemHoverBoat");
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntityHoverBoat entityboat = new EntityHoverBoat(p_77659_2_, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
